    ...
    return (
        <div className="flex flex-col items-start w-full">
            <div className="w-full p-2 md:p-4">
                ...
                <div className="mt-8">
                    <h2 className="text-xl font-medium mb-4">
                        Mental Health Challenges You are facing  ! 
                    </h2>
                            ...
                            {medications.map((medication) => (
                                <Card key={medication.id}>
                                    ...
                                    <CardContent>
                                        ...
                                        <p className="text-muted-foreground">
                                            Coping mechanisms do are using ? <span className="font-medium text-foreground">{medication.purpose}</span>
                                        </p>
                                        <p className="text-muted-foreground">
                                        How much you care Self-care Activities : <span className="font-medium text-foreground">{medication.adherence.toLowerCase()}</span>
                                        </p>
                                    </CardContent>
