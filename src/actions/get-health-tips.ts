...
const getHealthTips = async ({ symptoms, medications, user }: Props) => {
    ...
    const model = ai.getGenerativeModel({
        ...
        systemInstruction: "Generate mental health tips based on the user's symptoms and medications.Please only provide general health tips and do not give any medical advice.Do not tell the user to consult a doctor or seek medical help.Just provide general health recommendations based on the information provided."
    });
